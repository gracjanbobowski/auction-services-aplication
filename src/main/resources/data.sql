...
INSERT INTO users (user_id, username, email, password, enabled) VALUES
                                                                    ...
                                                                    (6, 'user', 'user', '$2a$10$KE0I4mQRfSEJsOV9wjUBMeJ6ENyMoUP4EixZPp5EDHLGJ70ufMF7.', 1),
                                                                    ...
                                                                    (11, 'admin', NULL, '$2a$10$PDBosED9CeLrhHH92y1Cre/iUaRIRCjADQLDQQ50qwSHnPn3lE7F6', 1),
                                                                    (12, 'user', NULL, '$2a$10$whHv4tfXCvFS8GlbzxuAHeH7QpZdfyw/gAqxlRH9TmeaYKVxiCiGm', 1),
                                                                    (13, 'user', NULL, '$2a$10$0Ow6A3XxQoR/YyoNDiwO5.Y1yPIYRoApOEWcEModRWZY9IhRA2LMC', 1);